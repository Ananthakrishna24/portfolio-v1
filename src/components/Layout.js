...
const Layout = ({ children }) => {
  ...
  return (
    <div className={`min-h-screen ${isDark ? 'dark bg-navy text-slate' : 'bg-light-bg text-light-text'}`}>
      <CursorLight />
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="py-12 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-light-text dark:text-lightest-slate">Ananthakrishna</h1>
          <p className="text-xl sm:text-2xl mt-2 text-light-primary dark:text-green">Senior Frontend Engineer</p>
